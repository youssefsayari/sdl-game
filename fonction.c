...
void positioncloud(SDL_Rect *poscloud1,SDL_Rect *poscloud2,SDL_Rect *poscloud3, int *direction,int *direction2,int *direction3)
{
    ...
    if(poscloud1->x==500 || poscloud1->x==10)
        (*direction)=-(*direction);
    poscloud2->x=poscloud2->x+(*direction2);
    if(poscloud2->x==500 || poscloud2->x==700)
        (*direction2)=-(*direction2);
    poscloud3->x=poscloud3->x+(*direction3);
    if(poscloud3->x==700 || poscloud3->x==1250)
...
int afficher_menu(SDL_Surface *screen,int coin)
{
    ...
    coins=IMG_Load("resources/image/coin.png");
	...
	SDL_BlitSurface(cloud3, NULL, screen, &poscloud3);
        SDL_BlitSurface(coins,NULL,screen,&poscoins);
        afficher_coins(coin,screen,police);
        //cursor
